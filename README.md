...
Not all images will contain a spaceship, but they will contain no more than 1. The metric used to evaluate the model will be the the Average Precision at an IoU threshold of 0.7.
...
![input_image](image_breakdown.png)
...
![input_image](models/clf/metrics.png)

### Regression Training Metrics

![input_image](models/reg/metrics.png)
